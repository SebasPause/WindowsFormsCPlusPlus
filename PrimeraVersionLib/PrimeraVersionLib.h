...
#ifdef PRIMERAVERSIONLIB_EXPORTS
#define PRIMERAVERSIONLIB_API __declspec(dllexport)
#else
#define PRIMERAVERSIONLIB_API __declspec(dllimport)
#endif

namespace PrimeraVersionLib {
    PRIMERAVERSIONLIB_API bool CompressFile(const char* src, const char* dst);
}
